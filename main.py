    ...
    for counter, url in enumerate(urls[0:10]):
        ...
        while trial < 5:
            try:
                ...
                # WebDriverWait(driver, 10).until(ec.presence_of_element_located((By.XPATH, load_more_locator)))
                # time.sleep(20)
...
if __name__ == '__main__':
    ...
    # working_proxies = ['41.186.44.106:3128', '103.159.195.9:8081', '182.52.131.125:8080', '181.129.52.154:42648', '181.113.135.254:52058']
