    ...
    for counter, url in enumerate(urls[0:10]):
        ...
        while trial < 5:
            try:
                ...
                driver.set_page_load_timeout(251)
                driver.get(url)
                try:
...
if __name__ == '__main__':
    ...
    scraped_proxies = get_proxy_2()
    working_proxies = choose_proxy(scraped_proxies)
    print(working_proxies)
    # working_proxies = ['103.175.202.10:8080', '101.226.17.188:9002', '180.183.67.218:8080', '101.226.20.25:9002', '201.71.2.49:999']
    ...
    # with multithreading
    # threads = min(MAX_THREADS, len(detail_urls))
